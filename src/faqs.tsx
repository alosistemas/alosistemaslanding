...
const Faqs = () => {
  return (
    <section id="faqs" className="bg-white flex flex-col items-center w-full pt-[60px] pb-[92px] md:pb-[80px] px-[24px] md:px-[32px] xl:px-[64px] gap-[60px] md:gap-[80px] relative">
      ...
      >
       ¿ Todavia tiene más preguntas ? 
        <span className="underline ml-1 cursor-pointer hover:text-[#475466]">
  
         <a href="#hero">Escríbenos</a>
         <br></br>
        </span>
        <span className="underline ml-1 cursor-pointer hover:text-[#475466]">
  <a href="tel:+51926306115">926-306-115</a>
 </span>
      </motion.h4>
